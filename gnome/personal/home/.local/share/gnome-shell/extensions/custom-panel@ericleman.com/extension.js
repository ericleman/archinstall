...
const MediaControlButton = Me.imports.mediaControlButton;
...
function enable(){
  ...
  this.mediaPlayer = new MediaControlButton.Extension();
  this.mediaPlayer.enable();
}
