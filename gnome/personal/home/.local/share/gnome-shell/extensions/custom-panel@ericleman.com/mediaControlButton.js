...
// FROM : https://github.com/Aylur/gnome-extensions/blob/main/src/mediaPlayer.js
...
class MediaButton extends PanelMenu.Button{
    _init(media){
        ...
        this.add_style_class_name('custom-color4');
...
class MediaControls extends St.BoxLayout{
    _init(media){
        ...
        this.prevBtn.add_style_class_name('custom-color4');
        this.playBtn.add_style_class_name('custom-color4');
        this.nextBtn.add_style_class_name('custom-color4');
...
var Extension = class Extension {
    ...
    reload(){
        ...
        this.panelButton = new MediaButton(this.media);
        this.controls = new MediaControls(this.media);

        let pos, offset

        Main.panel.addToStatusArea('Media Player', this.panelButton, 0, this.pos[1]);

        this.panelBox[1].insert_child_at_index(this.controls, 0);
